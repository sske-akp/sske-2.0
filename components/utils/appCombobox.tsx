...
export const AppCombobox = React.forwardRef<HTMLDivElement, AppComboboxProps>(
  function AppCombobox({ items, searchCategory, defaultValue = "", onValueChange }, forwardedRef) {
    ...
    // Merge forwardedRef with internal triggerRef
